			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(new TestMobileManager().isValidInteger(textFieldId.getText()) 
						...
						JOptionPane.showMessageDialog(AddView.this, "Error!", "Warning", JOptionPane.INFORMATION_MESSAGE);
					}
					...
					if(id!=0 && memory!=0 && total!=0 && price!=0) {
						...
						if(new TestMobileManager().addMobile(addM)) {
							JOptionPane.showMessageDialog(AddView.this, "Success", "Noti", JOptionPane.INFORMATION_MESSAGE);
							dispose();
							new HomeView().setVisible(true);
			
						}
						else {
							JOptionPane.showMessageDialog(AddView.this, "Failure", "Noti", JOptionPane.INFORMATION_MESSAGE);							
						}
					}
					else {
						JOptionPane.showMessageDialog(AddView.this, "Enter full information!", "Noti", JOptionPane.INFORMATION_MESSAGE);						
					}
				}catch(NumberFormatException e1) {
					JOptionPane.showMessageDialog(AddView.this, "Invalid input data", "Noti", JOptionPane.INFORMATION_MESSAGE);					
				}
			}
		});
		btnAdd.setForeground(new Color(0, 0, 205));
		btnAdd.setFont(new Font("Tahoma", Font.BOLD, 16));
		btnAdd.setBounds(319, 423, 96, 30);
		cpAdd.add(btnAdd);
